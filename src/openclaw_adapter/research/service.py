...
def _yuyutei_trip_cross_process_cooldown() -> None:
    try:
        ...
        pass
from .models import (  # noqa: E402 — cooldown helpers are defined above
    ActiveMarketSearchFn,
    ...
    SellerSnapshotFollowupFn,
    SellerSnapshotLookupFn,
    ShopReference,
    ShopReferenceFn,
    SoldAverageLookupFn,
    SoldMarketSearchFn,
...
from .input import (  # noqa: E402 — compatibility re-exports after constants
    ...
    parse_research_target as parse_research_target,
)
...
class ResearchCommandService:
    ...
    def run(self, raw_input: str, chat_id: str) -> str:
        ...
        return run(
            ...
            raw_input,
            chat_id,
            marketplace_total_budget_seconds=_MARKETPLACE_TOTAL_BUDGET_SECONDS,
            marketplace_heartbeat_interval_seconds=_MARKETPLACE_HEARTBEAT_INTERVAL_SECONDS,
            build_report=build_research_report,
        )
    ...
    def _stage_parse_input(self, ctx: ResearchJobContext) -> str:
        from .stages import parse_input

        return parse_input(self, ctx)

    def _stage_fetch_item_data(self, ctx: ResearchJobContext) -> str:
        from .stages import fetch_item_data
