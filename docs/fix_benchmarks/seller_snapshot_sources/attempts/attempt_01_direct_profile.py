"""Attempt 01: direct semantic profile parser.

This mirrors broken/parser.py. It intentionally passes direct profile fields
while failing noisy metric layouts and role-separated review tabs.
"""
