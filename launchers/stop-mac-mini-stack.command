...
LAUNCHCTL_LABELS=(local.openclaw.ollama local.openclaw.reputation local.openclaw.telegram local.openclaw.sns_monitor local.openclaw.price_monitor local.openclaw.chat_web local.openclaw.opportunity)
