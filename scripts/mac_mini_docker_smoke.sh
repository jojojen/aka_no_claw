...
run_smoke() {
  ...
  assert_file_contains "${WORKSPACE_DIR}/aka_no_claw/run/mac-mini-stack.env" "export PATH="
  assert_file_contains "${WORKSPACE_DIR}/aka_no_claw/run/mac-mini-stack.env" "export REPUTATION_AGENT_SERVER_URL="
  assert_file_contains "${WORKSPACE_DIR}/aka_no_claw/run/mac-mini-stack.env" "export REPUTATION_AGENT_ADMIN_TOKEN="
  assert_file_contains "${WORKSPACE_DIR}/aka_no_claw/run/mac-mini-stack.env" "export OPENCLAW_TESSERACT_PATH="
  ...
  assert_file_contains "${LOG_DIR}/brew.log" "brew install blueutil"
